...
submission = pd.DataFrame({
    'UID': uids,
    '채무 불이행 확률률': pred_labels  # 🚀 0 또는 1 값 저장
})

print("📌 CSV 저장을 시도합니다...")
submission.to_csv('submissions/test_predictions_xgboost.csv', index=False)
print("✅ CSV 저장 완료: 'submissions/test_predictions_xgboost.csv'")

# 8. 저장된 파일 확인
if os.path.exists("submissions/test_predictions_xgboost.csv"):
